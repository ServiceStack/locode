<template>
<div id="database-first" class="relative bg-gray-50 pt-16 overflow-hidden sm:pt-24 lg:pt-32">
  ...
  <div>
    <div class="relative overflow-hidden">
      ...
      <div class="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
        <div>
          <p class="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Database-first Example Locode App</p>
          <p class="mt-5 max-w-prose mx-auto text-xl text-gray-500">
            To demonstrate a database-first development workflow we've enabled
            <a class="text-indigo-600" href="https://docs.servicestack.net/autoquery-autogen">AutoGen</a> on the
            <b>Northwind</b> sample database to generate
...
<div class="bg-white pb-8 pb-12">
  <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
    <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
      <div>
        <div>
          <img class="h-11 w-auto" src="/assets/img/northwind/logo.svg" alt="Northwind Logo">
        </div>
        <div class="mt-20">
          <div>
          ...
          <div class="mt-6 sm:max-w-xl">
            ...
            <p class="mt-6 text-xl text-gray-500">
              ...
              <a class="text-indigo-600" href="https://docs.servicestack.net/autoquery-autogen">AutoGen</a> to generate
              <a class="text-indigo-600" href="https://docs.servicestack.net/autoquery-rdbms">AutoQuery</a> &amp;
              <a class="text-indigo-600" href="https://docs.servicestack.net/autoquery-crud">CRUD</a> APIs
        ...
        <div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
          <a href="https://northwind.locode.dev/locode">
            <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none"
                 src="/assets/img/northwind/screenshot.png" alt="">
          </a>
        </div>
      </div>
    </div>
