  ...
  <div class="pt-12 sm:pt-16 lg:pt-24">
    <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto space-y-2 lg:max-w-none">
        ...
        <p class="text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">Perpetual, Royalty-Free, Per-developer Pricing</p>
        <p class="text-xl text-gray-300">Unlimited usage of all ServiceStack Software, includes 12 months Software Maintenance & Commercial Support</p>
      </div>
    </div>
  </div>
            ...
            <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
              <ul role="list" class="space-y-4">
                <li class="flex items-start">
                  ...
                  <p class="ml-3 text-base text-gray-700">Unlimited usage</p>
                </li>
                ...
                <li class="flex items-start">
                  ...
                  <p class="ml-3 text-base text-gray-700">12 months Software Maintenance</p>
                </li>
                ...
                <li class="flex items-start">
                  ...
                  <p class="ml-3 text-base text-gray-700">Support Forums</p>
                </li>
                ...
                <li class="flex items-start">
                  ...
                  <p class="ml-3 text-base text-gray-700">Issue Tracker</p>
                </li>
              </ul>
          ...
          <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
              <ul role="list" class="space-y-4">
                ...
                <li class="flex items-start" title="Business licenses can be transferred when a developer leaves a project">
                  <div class="flex-shrink-0">
                    <!-- Heroicon name: outline/check -->
                    <svg class="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  ...
                  <p class="ml-3 text-base text-gray-700">Floating License</p>
                </li>

                <li class="flex items-start" title="Direct, private email support from ServiceStack expert engineers">
                  <div class="flex-shrink-0">
                    <!-- Heroicon name: outline/check -->
                    <svg class="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  ...
                  <p class="ml-3 text-base text-gray-700">4 incidents / year</p>
                </li>
              </ul>
              <div class="rounded-md shadow">
